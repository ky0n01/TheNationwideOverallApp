...
import {
  ...
  e2,
  u
} from "./chunk-5ZZ5WS56.js";
import {
  r
} from "./chunk-4LB6ML5C.js";
import {
  css,
  init_emotion_react_browser_esm,
  jsx
} from "./chunk-U4ABFPDF.js";
import {
  require_react
...
var i = null;
var r3 = function() {
  return i || (i = c2.createContext(null));
};
var a2 = function() {
  return c2.useContext(i);
};
var s = function(c4) {
  return "svg" === c4.target.tagName || "path" === c4.target.tagName || "DIV" === c4.target.tagName || "SPAN" === c4.target.tagName || "TD" === c4.target.tagName;
};
...
function u4(c4, t2) {
  var g = Object.keys(c4);
  if (Object.getOwnPropertySymbols) {
    var l = Object.getOwnPropertySymbols(c4);
    t2 && (l = l.filter(function(t3) {
      return Object.getOwnPropertyDescriptor(c4, t3).enumerable;
    })), g.push.apply(g, l);
  }
  return g;
}
function A2(c4) {
  for (var t2 = 1; t2 < arguments.length; t2++) {
    ...
    t2 % 2 ? u4(Object(g), true).forEach(function(t3) {
      e(c4, t3, g[t3]);
    }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(c4, Object.getOwnPropertyDescriptors(g)) : u4(Object(g)).forEach(function(t3) {
      Object.defineProperty(c4, t3, Object.getOwnPropertyDescriptor(g, t3));
    });
  }
  return c4;
}
...
var c3 = null;
var s2 = function() {
  return c3 || (c3 = t.createContext(null));
};
var i2 = function() {
  var n3 = t.useState(false), r5 = a(n3, 2), o5 = r5[0], u7 = r5[1];
  return t.useEffect(function() {
    var e5 = function(e6) {
      e6.shiftKey ? u7(true) : o5 && u7(false);
    }, t2 = function() {
      o5 && u7(false);
    };
    return document && (document.addEventListener("keydown", e5), document.addEventListener("keyup", t2)), function() {
      document && (document.removeEventListener("keydown", e5), document.removeEventListener("keyup", t2));
    };
  }, [o5]), o5;
};
var d3 = function() {
  return { select: a3(), tree: a2(), sort: W(), pagination: t.useContext(c3) };
};

// node_modules/@table-library/react-table-library/modifiers-d418f2b2.js
var o3 = function(o5) {
  var i5 = o5.sort, t2 = o5.pagination, a5 = o5.tree;
  return function(o6) {
    var e5 = u3(o6);
    return e5 = i5 ? i5.modifier(e5) : e5, e5 = t2 ? t2.modifier(e5) : e5, e5 = a5 ? a5.modifier(e5) : e5;
  };
};
...
function U(I) {
  for (var g = 1; g < arguments.length; g++) {
    var c4 = null != arguments[g] ? arguments[g] : {};
    g % 2 ? j(Object(c4), true).forEach(function(g2) {
      e(I, g2, c4[g2]);
    }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(I, Object.getOwnPropertyDescriptors(c4)) : j(Object(c4)).forEach(function(g2) {
      Object.defineProperty(I, g2, Object.getOwnPropertyDescriptor(c4, g2));
    });
  }
  return I;
}
var Q = function(l) {
  var t2, u7 = l.className, W2 = l.role, X2 = void 0 === W2 ? "rowheader" : W2, J = l.isFooter, a5 = l.children, y = e3(l, f), s4 = d4.useContext(b), m = d4.useRef(null);
  return t2 = d4.useContext(A), d4.useLayoutEffect(function() {
    var I;
    if (!t2) throw new Error("No Layout Context.");
    var g = t2.layout, c4 = t2.tableElementRef, l2 = t2.tableMemoryRef, b3 = u2(c4).map(G);
    if (null === (I = l2.current) || void 0 === I || !I.onlyOnce) if (l2.current.onlyOnce = true, null != g && g.resizedLayout) {
      ...
      r2(d5, c4, l2);
    } else if (null != g && g.custom) d(c4, l2);
    else {
...
var L = function(I, g, c4, l) {
  !function(I2) {
    ...
    return g(l, I2);
  } : z, onDoubleClick: c4 ? function(I2) {
    return c4(l, I2);
  } : null, ref: I });
};
...
function w(I) {
  for (var g = 1; g < arguments.length; g++) {
    var c4 = null != arguments[g] ? arguments[g] : {};
    g % 2 ? D(Object(c4), true).forEach(function(g2) {
      e(I, g2, c4[g2]);
    }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(I, Object.getOwnPropertyDescriptors(c4)) : D(Object(c4)).forEach(function(g2) {
      Object.defineProperty(I, g2, Object.getOwnPropertyDescriptor(c4, g2));
    });
  }
  return I;
...
var O = function(l) {
  var b3 = l.item, C = l.className, e5 = l.disabled, n3 = l.onClick, A3 = l.onDoubleClick, t2 = l.children, u7 = e3(l, k), W2 = function(I, g) {
    return Object.values(I).filter(Boolean).filter(function(I2) {
      return null == I2 ? void 0 : I2.hasOwnProperty("_getRowProps");
    }).map(function(c4) {
      return c4._getRowProps(g, I);
    });
  }(d3(), l), X2 = d4.useContext(b), J = function(I, g) {
    var c4 = I.reduce(function(I2, g2) {
      var c5 = g2.theme, l2 = g2.className, b4 = g2.onClick, C2 = "\n        ".concat(I2.themeByFeature, "\n        ").concat(c5, "\n      "), e6 = clsx_m_default(I2.classNamesByFeature, l2), n4 = I2.clickable || !!b4;
      return w(w({}, I2), {}, { themeByFeature: C2, classNamesByFeature: e6, clickable: n4, onClickByFeature: function(g3, c6) {
        b4(g3, c6), I2.onClickByFeature(g3, c6);
      } });
    }, { themeByFeature: "", classNamesByFeature: "", clickable: !!g, onClickByFeature: function(I2, c5) {
      g && s(c5) && g(I2, c5);
    } });
...
function u6(r5, e5) {
  var t2 = Object.keys(r5);
  if (Object.getOwnPropertySymbols) {
    var n3 = Object.getOwnPropertySymbols(r5);
    e5 && (n3 = n3.filter(function(e6) {
      return Object.getOwnPropertyDescriptor(r5, e6).enumerable;
    })), t2.push.apply(t2, n3);
  }
  return t2;
}
function f2(r5) {
  for (var e5 = 1; e5 < arguments.length; e5++) {
    var n3 = null != arguments[e5] ? arguments[e5] : {};
    e5 % 2 ? u6(Object(n3), true).forEach(function(e6) {
      e(r5, e6, n3[e6]);
    }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(r5, Object.getOwnPropertyDescriptors(n3)) : u6(Object(n3)).forEach(function(e6) {
      Object.defineProperty(r5, e6, Object.getOwnPropertyDescriptor(n3, e6));
    });
  }
  return r5;
}
var i4 = function(r5, e5) {
  if ("SET" === e5.type) return function(r6, e6) {
    return f2(f2({}, r6), e6.payload);
  }(r5, e5);
  throw new Error();
};
var s3 = {};
var p3 = function(r5, t2, a5, u7) {
  var p4, l = f2(f2({}, s3), null !== (p4 = null == a5 ? void 0 : a5.state) && void 0 !== p4 ? p4 : {}), y = null != a5 && a5.onChange ? a5.onChange : function() {
  }, O2 = e2(i4, l, [], [y], u7), b3 = a(O2, 2), j2 = b3[0], d5 = b3[1];
  return c(l, j2, function() {
    return d5({ type: "SET", payload: l });
  }), u(r5, u7, j2), j2;
};
