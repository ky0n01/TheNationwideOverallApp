...
//import nodes from 'https://gist.githubusercontent.com/ky0n01/9bb6e6c6593b7f7de9e1f29aad857acc/raw/95fc928799fbef0d54b944a968c6f3c95e6c53f4/2024NAL.json'
  ...
  const sort = useSort(
    ...
    },  
    {
      sortFns: {
        ...
        psgs_code:(array) => array.sort((a, b) => a.psgs_code.localeCompare(b.psgs_code)),
        provid:   (array) => array.sort((a, b) => a.provid.localeCompare(b.provid)),
